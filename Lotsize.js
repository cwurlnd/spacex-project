let lotChart = document.getElementById('Lotsize').getContext('2d');
    ...
    for (key in vendorQuickStats){
      dictKeys.push(key);
      dictValues.push(vendorQuickStats[key][0]);
    }
    ...
    let LotChart = new Chart(lotChart, {
